    ...
    public static function set_breadcrumb($page_name, $category_name) {
        ...
        if ($page_name === 'home') :
            ...
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                <li class="breadcrumb-item active" aria-current="page"> <a href="javascript:void(0);"> <span>' . $page .'</span></a></li>';
        elseif ($page_name === 'view_customers') :
            ...
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                ...
                ';
        // Apps
        elseif ($page_name === 'create_customer') :
            // echo 'Fullcalendar Drag and Drop Event ' . $admin_name;
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);"><span>' . $page .'</span></a></li>';
        elseif ($page_name === 'view_services') :
            // echo 'Chat Application ' . $admin_name;
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);"><span>' . $page .'</span></a></li>';
        elseif ($page_name === 'create_service') :
            // echo 'Contact Profile ' . $admin_name;
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);"><span>' . $page .'</span></a></li>';
        elseif ($page_name === 'view_reminders') :
            // echo 'Invoice ' . $admin_name;
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);"><span>' . $page .'</span></a></li>';
        elseif ($page_name === 'archived_reminders') :
            // echo 'Mailbox ' . $admin_name;
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);"><span>' . $page .'</span></a></li>';
        elseif ($page_name === 'create_reminder') :
            // echo 'Notes ' . $admin_name;
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);"><span>' . $page .'</span></a></li>';
        elseif ($page_name === 'view_users') :
            // echo 'Scrum Task Board ' . $admin_name;
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                <li class="breadcrumb-item active" aria-current="page"> <a href="javascript:void(0);"> <span>' . $page .'</span></a></li>';
        elseif ($page_name === 'create_user') :
            // echo 'Todo List ' . $admin_name;
            echo '<li class="breadcrumb-item"><a href="javascript:void(0);">'. $category .'</a></li>
                <li class="breadcrumb-item active" aria-current="page"> <a href="javascript:void(0);"> <span> ' . $page .'</span> </a> </li>';
